...
// Format phone number for Telegram display
...
`;
                ...
                await bot.sendMessage(chatId, `
👋 *Welcome to Liftisha Loan Platform!*
...
app.get('/', async (req, res) => {
    ...
    res.sendFile(path.join(__dirname, 'liftisha-integrated.html'));
});
